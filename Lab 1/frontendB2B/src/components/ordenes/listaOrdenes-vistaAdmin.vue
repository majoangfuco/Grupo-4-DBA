...
// Tabla de órdenes para el administrador.
//   - Recibe todas las órdenes del sistema como prop.
//   - El padre (Ordenes-PaginaAdmin.vue) llama a GET /api/ordenes.
// =====================================================
...
<template>
  <div class="tabla-contenedor">
    <table class="tabla" aria-label="Lista de todas las órdenes">
      ...
      <tbody>
        ...
        <template v-else>
          <tr v-for="orden in ordenes" :key="orden.orden_ID" class="fila-orden">
            ...
            <td class="celda">{{ orden.usuario_ID }}</td>
            <td class="celda">{{ orden.carrito_ID }}</td>
            <td class="celda">{{ orden.info_Entrega_ID }}</td>
