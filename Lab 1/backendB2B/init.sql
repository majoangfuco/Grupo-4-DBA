...
(1, 'COMPLETADO', 3350000),   -- Carrito 1 (Completado)
(2, 'ACTIVO', 450000),       -- Carrito 2 (Activo)
(4, 'COMPLETADO', 1260000),  -- Carrito 3 (Completado)
(6, 'COMPLETADO', 3400000),  -- Carrito 4 (Completado)
(7, 'COMPLETADO', 255000),   -- Carrito 5 (Completado)
