    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        // Chequeo de infraestructura del replica set: público
                        // a propósito, para poder validar el despliegue sin
                        // tener que autenticarse primero.
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/mongo/health").permitAll()
                        ...
                        .hasRole("ADMIN")
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/almacenes/**")
                        .authenticated()
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/almacenes/**")
                        .hasRole("ADMIN")
                        .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/almacenes/**")
                        .hasRole("ADMIN")
                        .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/api/almacenes/**")
                        .hasRole("ADMIN")
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/config/**")
                        .authenticated()
                        .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/config/**")
                        .hasRole("ADMIN")
